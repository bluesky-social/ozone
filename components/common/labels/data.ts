// IMPORTANT: This is copy-pasted from previously defined labels in the @atproto/api sdk
// we should revisit this once the sdk update is complete and we are ready to align label definitions
